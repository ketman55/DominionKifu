...
export const initialCardCounts: { [key: string]: number } = {
    ...
    //Cornucopia&Guilds
    sCandlestickMaker: lowData.Standard,
    ...
    Coronet: lowData.Standard,
    Courser: lowData.Standard,
    Demesne: lowData.Standard,
    Housecarl: lowData.Standard,
    HugeTurnip: lowData.Standard,
    Renown: lowData.Standard,
    MerchantGuild: lowData.Standard,
    Soothsayer: lowData.Standard,
    Fairgrounds: lowData.Standard,
    ...
    BagofGold: lowData.Standard,
    Diadem: lowData.Standard,
    Followers: lowData.Standard,
    Princess: lowData.Standard,
    TrustySteed: lowData.Standard,
    ...
    KnightsDamesAnna: lowData.Standard,
    Josephine: lowData.Standard,
    Molly: lowData.Standard,
    Natalie: lowData.Standard,
    Sylvia: lowData.Standard,
    SirsBailey: lowData.Standard,
    Destry: lowData.Standard,
    Martin: lowData.Standard,
    Michael: lowData.Standard,
    Vander: lowData.Standard,
    ...
    CastlesHumble: lowData.Standard,
    ...
    SecretCaveMagicLamp: lowData.Standard,
    Bard: lowData.Standard,
    BlessedVillage: lowData.Standard,
    CemeteryHauntedMirror: lowData.Standard,
    ...
    PookaCursedGold: lowData.Standard,
